export const frFR = {
  ...
  podcasts: {
    ...
    modeQuestion: "Que voulez-vous créer ?",
    modePodcast: "Podcast",
    modePodcastDesc: "Des animateurs discutent de votre contenu dans un épisode",
    modeBriefing: "Briefing",
    modeBriefingDesc: "Une voix lit et analyse vos notes",
    transcriptSaved: "Transcription enregistrée",
    voiceYourVoices: "Vos voix",
    voiceCloned: "Voix clonée",
    voiceCloneTitle: "Cloner une nouvelle voix",
    voiceCloneNamePlaceholder: "Nom de la voix",
    voiceCloneUpload: "Téléverser un enregistrement",
    voiceCloneBusy: "Clonage…",
    voiceCloneHint: "10–20 secondes de parole claire (wav, mp3 ou m4a). Transcrit et cloné localement.",
    voiceCloneFailed: "Impossible de cloner la voix",
    downloadAudio: "Audio",
    ...
    changeVoice: "Modifier",
    voicesHeading: "Voix",
    voiceCustomId: "ID de voix personnalisé",
    voiceApply: "Appliquer",
    voiceDone: "Terminé",
    voiceFilterAll: "Toutes",
    voiceFilterFemale: "Féminine",
    voiceFilterMale: "Masculine",
    voiceFilterUS: "É.-U.",
    voiceFilterUK: "R.-U.",
    voicePlaySample: "Écouter un extrait",
    voiceStopSample: "Arrêter",
    voiceSavesToProfile: "Les changements de voix sont enregistrés dans la configuration des intervenants « {name} ».",
    voiceReadMyContent: "Lire mon contenu",
    voiceReadMyContentDesc: "Écoutez cette voix lire le début de votre contenu",
    voicePreviewFailed: "Échec de l'aperçu de la voix",
