export const enUS = {
  ...
  podcasts: {
    ...
    episodeProfile: "Episode format",
    episodeProfilePlaceholder: "Select an episode format",
    modeQuestion: "What do you want to create?",
    modePodcast: "Podcast",
    ...
    voiceYourVoices: "Your voices",
    voiceCloned: "Cloned voice",
    voiceCloneTitle: "Clone a new voice",
    voiceCloneNamePlaceholder: "Voice name",
    voiceCloneUpload: "Upload recording",
    voiceCloneBusy: "Cloning…",
    voiceCloneHint: "10–20 seconds of clear speech (wav, mp3, or m4a). Transcribed and cloned locally.",
    voiceCloneFailed: "Could not clone voice",
    downloadAudio: "Audio",
    ...
    profileRequired: "Episode Format Required",
    profileRequiredDesc: "Select an episode format before generating a podcast.",
    ...
    usesSpeakerProfile: "Uses speaker configuration",
    sources: "Sources",
    notes: "Notes",
    ...
    loadingProfiles: "Loading episode formats...",
    noProfilesFound: "No episode formats found. Create an episode format before generating a podcast.",
    listTitle: "Podcasts",
    ...
    episodeProfilesSetFormat: "Episode formatting sets the structure",
    ...
    speakerProfilesBringVoices: "Speaker configurations bring voices to life",
    ...
    workflowStep1: "Create speaker configurations for each voice you need",
    workflowStep2: "Build episode formats that reference those speakers by name",
    workflowStep3: "Generate podcasts by selecting the episode format that fits the story",
    workflowHint: "Episode formats reference speaker configurations by name, so starting with speakers avoids missing voice assignments later.",
    ...
    speakerProfilesTitle: "Speaker configurations",
    speakerProfilesDesc: "Configure voices and personalities for generated episodes.",
    createSpeaker: "Create speaker",
    noSpeakerProfiles: "No speaker configurations yet. Create one to make episode formats available.",
    ...
    voiceDone: "Done",
    voiceFilterAll: "All",
    voiceFilterFemale: "Female",
    voiceFilterMale: "Male",
    voiceFilterUS: "US",
    voiceFilterUK: "UK",
    voicePlaySample: "Play sample",
    voiceStopSample: "Stop",
    voiceSavesToProfile: "Voice changes are saved to the “{name}” speaker configuration.",
    voiceReadMyContent: "Read my content",
    voiceReadMyContentDesc: "Hear this voice read the opening of your uploaded content",
    voicePreviewFailed: "Voice preview failed",
    backstory: "Backstory",
    personality: "Personality",
    edit: "Edit",
    duplicate: "Duplicate",
    deleteSpeakerProfileTitle: "Delete speaker configuration?",
    deleteSpeakerProfileDesc: "Deleting “{name}” cannot be undone.",
    deleteSpeakerDisabledHint: "Remove this speaker from episode formats before deleting it.",
    deleting: "Deleting…",
    episodeProfilesTitle: "Episode formatting",
    episodeProfilesDesc: "Define reusable generation settings for your shows.",
    createProfile: "Create profile",
    createSpeakerFirst: "Create a speaker configuration before adding an episode format.",
    noEpisodeProfiles: "No episode formats yet. Create one to kickstart podcast generation.",
    speakerCreated: "Speaker Created",
    speakerCreatedDesc: "The speaker \"{name}\" has been successfully added.",
    failedToCreateSpeaker: "Failed to create speaker configuration",
    speakerUpdated: "Speaker Updated",
    speakerUpdatedDesc: "The speaker \"{name}\" has been successfully updated.",
    failedToUpdateSpeaker: "Failed to update speaker configuration",
    speakerDeleted: "Speaker Deleted",
    speakerDeletedDesc: "The speaker \"{name}\" has been successfully removed.",
    failedToDeleteSpeaker: "Failed to delete speaker configuration",
    speakerDuplicated: "Speaker Duplicated",
    speakerDuplicatedDesc: "The speaker \"{name}\" has been successfully duplicated.",
    failedToDuplicateSpeaker: "Failed to duplicate speaker configuration",
    ...
    profileCreatedDesc: "The episode format \"{name}\" has been successfully created.",
    failedToCreateProfile: "Failed to create profile",
    profileUpdated: "Profile Updated",
    profileUpdatedDesc: "The episode format \"{name}\" has been successfully updated.",
    failedToUpdateProfile: "Failed to update profile",
    profileDeleted: "Profile Deleted",
    profileDeletedDesc: "The episode format \"{name}\" has been successfully removed.",
    failedToDeleteProfile: "Failed to delete profile",
    failedToDeleteProfileDesc: "Failed to remove the episode format.",
    profileDuplicated: "Profile Duplicated",
    profileDuplicatedDesc: "The episode format \"{name}\" has been successfully duplicated.",
    ...
    failedToDeleteSpeakerDesc: "Failed to remove the speaker configuration.",
    ...
    embedded: "Embedded",
    notEmbedded: "Not embedded",
    noSpeakerProfilesAvailable: "No speaker configurations available",
    editEpisodeProfile: "Edit Episode Format",
    createEpisodeProfile: "Create Episode Format",
    episodeProfileFormDesc: "Define how episodes should be generated and which speaker configuration they use by default.",
    noSpeakerProfilesDesc: "Create a speaker configuration before configuring an episode format.",
    ...
    selectSpeakerProfile: "Select a speaker configuration",
    ...
    editSpeakerProfile: "Edit Speaker Configuration",
    createSpeakerProfile: "Create Speaker Configuration",
