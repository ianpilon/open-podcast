export const bnIN = {
  ...
  podcasts: {
    ...
    modeQuestion: "আপনি কী তৈরি করতে চান?",
    modePodcast: "পডকাস্ট",
    ...
    voiceYourVoices: "আপনার কণ্ঠ",
    voiceCloned: "ক্লোন করা কণ্ঠ",
    voiceCloneTitle: "নতুন কণ্ঠ ক্লোন করুন",
    voiceCloneNamePlaceholder: "কণ্ঠের নাম",
    voiceCloneUpload: "রেকর্ডিং আপলোড করুন",
    voiceCloneBusy: "ক্লোন হচ্ছে…",
    voiceCloneHint: "১০–২০ সেকেন্ডের স্পষ্ট কথা (wav, mp3 বা m4a)। স্থানীয়ভাবে প্রতিলিপি ও ক্লোন হয়।",
    voiceCloneFailed: "কণ্ঠ ক্লোন করা যায়নি",
    downloadAudio: "অডিও",
    ...
    unused: "অব্যবহৃত",
    voiceId: "ভয়েস ID",
    chooseVoice: "একটি কণ্ঠ বেছে নিন",
    changeVoice: "পরিবর্তন",
    voicesHeading: "কণ্ঠস্বর",
    voiceCustomId: "কাস্টম ভয়েস আইডি",
    voiceApply: "প্রয়োগ করুন",
    voiceDone: "সম্পন্ন",
    voiceFilterAll: "সব",
    voiceFilterFemale: "মহিলা",
    voiceFilterMale: "পুরুষ",
    voiceFilterUS: "মার্কিন",
    voiceFilterUK: "ব্রিটিশ",
    voicePlaySample: "নমুনা শুনুন",
    voiceStopSample: "থামান",
    voiceSavesToProfile: "কণ্ঠের পরিবর্তনগুলি “{name}” বক্তা কনফিগারেশনে সংরক্ষিত হয়।",
    voiceReadMyContent: "আমার লেখা পড়ে শোনান",
    voiceReadMyContentDesc: "আপলোড করা বিষয়বস্তুর শুরুটা এই কণ্ঠে শুনুন",
    voicePreviewFailed: "ভয়েস প্রিভিউ ব্যর্থ হয়েছে",
