export const ptBR = {
  ...
  podcasts: {
    ...
    modeQuestion: "O que você quer criar?",
    modePodcast: "Podcast",
    ...
    voiceYourVoices: "Suas vozes",
    voiceCloned: "Voz clonada",
    voiceCloneTitle: "Clonar uma nova voz",
    voiceCloneNamePlaceholder: "Nome da voz",
    voiceCloneUpload: "Enviar gravação",
    voiceCloneBusy: "Clonando…",
    voiceCloneHint: "10–20 segundos de fala clara (wav, mp3 ou m4a). Transcrito e clonado localmente.",
    voiceCloneFailed: "Não foi possível clonar a voz",
    downloadAudio: "Áudio",
    ...
    voiceFilterFemale: "Feminina",
    voiceFilterMale: "Masculina",
    voiceFilterUS: "EUA",
    voiceFilterUK: "Reino Unido",
    voicePlaySample: "Ouvir amostra",
    voiceStopSample: "Parar",
    voiceSavesToProfile: "As alterações de voz são salvas na configuração de locutores “{name}”.",
    voiceReadMyContent: "Ler meu conteúdo",
    voiceReadMyContentDesc: "Ouça esta voz lendo o início do seu conteúdo enviado",
    voicePreviewFailed: "Falha na prévia da voz",
    backstory: "História",
