export const ruRU = {
  ...
  podcasts: {
    ...
    modeQuestion: "Что вы хотите создать?",
    modePodcast: "Подкаст",
    ...
    voiceYourVoices: "Ваши голоса",
    voiceCloned: "Клонированный голос",
    voiceCloneTitle: "Клонировать новый голос",
    voiceCloneNamePlaceholder: "Название голоса",
    voiceCloneUpload: "Загрузить запись",
    voiceCloneBusy: "Клонирование…",
    voiceCloneHint: "10–20 секунд чёткой речи (wav, mp3 или m4a). Расшифровка и клонирование локально.",
    voiceCloneFailed: "Не удалось клонировать голос",
    downloadAudio: "Аудио",
    ...
    voicesHeading: "Голоса",
    voiceCustomId: "Свой ID голоса",
    voiceApply: "Применить",
    voiceDone: "Готово",
    voiceFilterAll: "Все",
    voiceFilterFemale: "Женский",
    voiceFilterMale: "Мужской",
    voiceFilterUS: "США",
    voiceFilterUK: "Великобритания",
    voicePlaySample: "Прослушать образец",
    voiceStopSample: "Стоп",
    voiceSavesToProfile: "Изменения голоса сохраняются в конфигурации дикторов «{name}».",
    voiceReadMyContent: "Прочитать мой текст",
    voiceReadMyContentDesc: "Послушайте, как этот голос читает начало вашего материала",
    voicePreviewFailed: "Не удалось выполнить предпросмотр голоса",
    backstory: "Биография",
