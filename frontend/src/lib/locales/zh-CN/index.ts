export const zhCN = {
  ...
  podcasts: {
    ...
    voiceYourVoices: "你的声音",
    voiceCloned: "克隆声音",
    voiceCloneTitle: "克隆新声音",
    voiceCloneNamePlaceholder: "声音名称",
    voiceCloneUpload: "上传录音",
    voiceCloneBusy: "克隆中…",
    voiceCloneHint: "10–20秒清晰语音（wav、mp3或m4a）。在本地转录并克隆。",
    voiceCloneFailed: "无法克隆声音",
    downloadAudio: "音频",
    audioSaved: "音频已保存",
    episodeName: "单集名称",
    ...
    changeVoice: "更改",
    voicesHeading: "声音",
    voiceCustomId: "自定义声音 ID",
    voiceApply: "应用",
    voiceDone: "完成",
    voiceFilterAll: "全部",
    voiceFilterFemale: "女声",
    voiceFilterMale: "男声",
    voiceFilterUS: "美音",
    voiceFilterUK: "英音",
    voicePlaySample: "播放示例",
    voiceStopSample: "停止",
    voiceSavesToProfile: "声音更改将保存到“{name}”主播配置中。",
    voiceReadMyContent: "朗读我的内容",
    voiceReadMyContentDesc: "让这个声音朗读您上传内容的开头",
    voicePreviewFailed: "语音预览失败",
    backstory: "背景故事",
    personality: "性格",
    edit: "编辑",
    duplicate: "复制",
