export const jaJP = {
  ...
  podcasts: {
    ...
    voiceYourVoices: "あなたの声",
    voiceCloned: "クローン音声",
    voiceCloneTitle: "新しい声をクローン",
    voiceCloneNamePlaceholder: "声の名前",
    voiceCloneUpload: "録音をアップロード",
    voiceCloneBusy: "クローン中…",
    voiceCloneHint: "10〜20秒のはっきりした音声（wav、mp3、m4a）。ローカルで文字起こしとクローンを行います。",
    voiceCloneFailed: "声をクローンできませんでした",
    downloadAudio: "音声",
    ...
    changeVoice: "変更",
    voicesHeading: "ボイス",
    voiceCustomId: "カスタム音声ID",
    voiceApply: "適用",
    voiceDone: "完了",
    voiceFilterAll: "すべて",
    voiceFilterFemale: "女性",
    voiceFilterMale: "男性",
    voiceFilterUS: "米国",
    voiceFilterUK: "英国",
    voicePlaySample: "サンプルを再生",
    voiceStopSample: "停止",
    voiceSavesToProfile: "声の変更は話者設定「{name}」に保存されます。",
    voiceReadMyContent: "自分のコンテンツを読み上げ",
    voiceReadMyContentDesc: "アップロードした内容の冒頭をこの声で聞く",
