export const itIT = {
  ...
  podcasts: {
    ...
    voiceYourVoices: "Le tue voci",
    voiceCloned: "Voce clonata",
    voiceCloneTitle: "Clona una nuova voce",
    voiceCloneNamePlaceholder: "Nome della voce",
    voiceCloneUpload: "Carica registrazione",
    voiceCloneBusy: "Clonazione…",
    voiceCloneHint: "10–20 secondi di parlato chiaro (wav, mp3 o m4a). Trascritto e clonato localmente.",
    voiceCloneFailed: "Impossibile clonare la voce",
    downloadAudio: "Audio",
    ...
    changeVoice: "Cambia",
    voicesHeading: "Voci",
    voiceCustomId: "ID voce personalizzato",
    voiceApply: "Applica",
    voiceDone: "Fatto",
    voiceFilterAll: "Tutte",
    voiceFilterFemale: "Femminile",
    voiceFilterMale: "Maschile",
    voiceFilterUS: "USA",
    voiceFilterUK: "Regno Unito",
    voicePlaySample: "Riproduci campione",
    voiceStopSample: "Interrompi",
    voiceSavesToProfile: "Le modifiche alla voce vengono salvate nella configurazione dei relatori “{name}”.",
    voiceReadMyContent: "Leggi il mio contenuto",
    voiceReadMyContentDesc: "Ascolta questa voce leggere l'inizio del tuo contenuto",
    voicePreviewFailed: "Anteprima voce non riuscita",
