export const esES = {
  ...
  podcasts: {
    ...
    modeQuestion: "¿Qué quieres crear?",
    modePodcast: "Pódcast",
    ...
    voiceYourVoices: "Tus voces",
    voiceCloned: "Voz clonada",
    voiceCloneTitle: "Clonar una nueva voz",
    voiceCloneNamePlaceholder: "Nombre de la voz",
    voiceCloneUpload: "Subir grabación",
    voiceCloneBusy: "Clonando…",
    voiceCloneHint: "10–20 segundos de habla clara (wav, mp3 o m4a). Se transcribe y clona localmente.",
    voiceCloneFailed: "No se pudo clonar la voz",
    downloadAudio: "Audio",
    ...
    unused: "Sin usar",
    voiceId: "ID de voz",
    chooseVoice: "Elegir una voz",
    changeVoice: "Cambiar",
    voicesHeading: "Voces",
    voiceCustomId: "ID de voz personalizado",
    voiceApply: "Aplicar",
    voiceDone: "Hecho",
    voiceFilterAll: "Todas",
    voiceFilterFemale: "Femenina",
    voiceFilterMale: "Masculina",
    voiceFilterUS: "EE. UU.",
    voiceFilterUK: "Reino Unido",
    voicePlaySample: "Reproducir muestra",
    voiceStopSample: "Detener",
    voiceSavesToProfile: "Los cambios de voz se guardan en la configuración de locutores “{name}”.",
    voiceReadMyContent: "Leer mi contenido",
    voiceReadMyContentDesc: "Escucha esta voz leyendo el inicio de tu contenido",
    voicePreviewFailed: "Error en la vista previa de voz",
    backstory: "Historia",
