export const zhTW = {
  ...
  podcasts: {
    ...
    voiceYourVoices: "你的聲音",
    voiceCloned: "克隆聲音",
    voiceCloneTitle: "克隆新聲音",
    voiceCloneNamePlaceholder: "聲音名稱",
    voiceCloneUpload: "上傳錄音",
    voiceCloneBusy: "克隆中…",
    voiceCloneHint: "10–20秒清晰語音（wav、mp3或m4a）。在本地轉錄並克隆。",
    voiceCloneFailed: "無法克隆聲音",
    downloadAudio: "音訊",
    audioSaved: "音訊已儲存",
    episodeName: "單集名稱",
    ...
    changeVoice: "變更",
    voicesHeading: "聲音",
    voiceCustomId: "自訂聲音 ID",
    voiceApply: "套用",
    voiceDone: "完成",
    voiceFilterAll: "全部",
    voiceFilterFemale: "女聲",
    voiceFilterMale: "男聲",
    voiceFilterUS: "美音",
    voiceFilterUK: "英音",
    voicePlaySample: "播放範例",
    voiceStopSample: "停止",
    voiceSavesToProfile: "聲音變更將儲存至「{name}」主播設定。",
    voiceReadMyContent: "朗讀我的內容",
    voiceReadMyContentDesc: "讓這個聲音朗讀您上傳內容的開頭",
    voicePreviewFailed: "語音預覽失敗",
    backstory: "背景故事",
    personality: "性格",
    edit: "編輯",
    duplicate: "複製",
